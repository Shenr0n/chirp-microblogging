import { CHIRP_CREATE_FAILURE, CHIRP_CREATE_REQUEST, CHIRP_CREATE_SUCCESS, CHIRP_DELETE_FAILURE, CHIRP_DELETE_REQUEST, CHIRP_DELETE_SUCCESS, FIND_CHIRP_BY_ID_FAILURE, FIND_CHIRP_BY_ID_REQUEST, FIND_CHIRP_BY_ID_SUCCESS, GET_ALL_CHIRPS_SUCCESS, GET_USERS_CHIRP_SUCCESS, LIKE_CHIRP_FAILURE, LIKE_CHIRP_REQUEST, LIKE_CHIRP_SUCCESS, RECHIRP_FAILURE, RECHIRP_REQUEST, RECHIRP_SUCCESS, REPLY_CHIRP_SUCCESS, USER_LIKE_CHIRP_FAILURE, USER_LIKE_CHIRP_REQUEST, USER_LIKE_CHIRP_SUCCESS } from "./ActionType";
...
export const chirpReducer=(state=initialState,action)=>{
    ...
    switch (action.type) {
        ...
        case GET_USERS_CHIRP_SUCCESS:
            const{userId, chirps} = action.payload;
            return {
                ...state,
                loading:false,
                error:null,
...
/*        case USER_LIKE_CHIRP_SUCCESS:
            return {
                ...
                loading:false,
                error:null,
                likedChirps:action.payload
            };*/

            case USER_LIKE_CHIRP_SUCCESS:
                const{likedUserId, likedChirps} = action.payload;
                return {
                    ...state,
                    loading:false,
                    error:null,
